...
"""
This file is a companion to `Nonlinear Langevin Double Well.jl` which generates
the contities referenced here.

The main outputs needed from the above mentioned file is `h_wf_packs`
"""
